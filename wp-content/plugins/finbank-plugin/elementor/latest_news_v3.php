                    ...
                    <div class="single-blog-style1 wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        ...
                        <div class="text-holder">
                            ...
                            <div class="bottom">
                                <div class="meta-box">
                                    <ul class="meta-info">
                                        <?php if( $options->get( 'blog_post_date' ) ){ ?><li><span class="icon-clock"></span> <a href="<?php echo get_month_link(get_the_date('Y'), get_the_date('m')); ?>"><?php esc_html_e( 'Posted : ', 'finbank' );?><?php echo wp_kses(get_the_time(), true); ?></a></li><?php } ?>
