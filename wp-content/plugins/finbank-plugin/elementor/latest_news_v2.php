                    ...
                    <div class="single-blog-style1 single-blog-style1--style2">
                        ...
                        <div class="text-holder">
                            ...
                            <div class="bottom">
                                ...
                                <div class="meta-box">
                                    <ul class="meta-info">
                                        <li><span class="icon-clock"></span> <a href="<?php echo get_month_link(get_the_date('Y'), get_the_date('m')); ?>"><?php esc_html_e( 'Posted : ', 'finbank' );?><?php echo wp_kses(get_the_time(), true); ?></a></li>
