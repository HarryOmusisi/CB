...
function finbank_enqueue_scripts() {
	...
	wp_enqueue_style( 'finbank-jquery-ui', get_template_directory_uri() . '/assets/vendors/jquery-ui/jquery-ui.css' );
	wp_enqueue_style( 'finbank-nice-select', get_template_directory_uri() . '/assets/vendors/nice-select/nice-select.css' );
	...
	wp_enqueue_style( 'finbank-swiper', get_template_directory_uri() . '/assets/vendors/swiper/swiper.min.css' );
	wp_enqueue_style( 'vegas', get_template_directory_uri() . '/assets/vendors/vegas/vegas.min.css' );
	wp_enqueue_style( 'style', get_template_directory_uri() . '/assets/vendors/thm-icons/style.css' );
	...
	wp_enqueue_script( 'finbank-swiper', get_template_directory_uri().'/assets/vendors/swiper/swiper.min.js', array( 'jquery' ), '2.1.2', true );
	...
	wp_enqueue_script( 'jquery-polyglot-language', get_template_directory_uri().'/assets/vendors/language-switcher/jquery.polyglot.language.switcher.js', array( 'jquery' ), '2.1.2', true );
