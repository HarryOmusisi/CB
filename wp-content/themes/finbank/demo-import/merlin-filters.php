...
function finbank_local_import_files() {
	return array(
		array(
			...
			'preview_url'              => 'http://fastwpdemo.com/newwp/finbank/',
		),
	);
}
...
function finbank_after_import_setup() {
	...
	$footer_about_menu = get_term_by( 'name', 'Footer Widget Menu', 'nav_menu' );
	...
	set_theme_mod(
		'nav_menu_locations', array(
			...
			'footer_about_menu' => $footer_about_menu->term_id,
		)
	);
